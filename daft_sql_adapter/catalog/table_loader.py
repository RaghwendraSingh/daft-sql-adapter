"""Load Unity Catalog tables into a Daft Session as temp tables (full names)."""
...
class TableLoader:
    """Loads a list of Unity Catalog tables into a Daft Session for SQL execution."""
    ...
    def load_into_session(
        ...
        """
        Load each table from Unity Catalog and register it in the session
        ...
        for name in table_names:
            ...
            try:
                ...
                session.create_temp_table(full_name, df)
